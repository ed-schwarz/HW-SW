...
all:
	cmd /c "cd /D ""C:\\usr\\xtensa\\Xplorer-7.0.7-workspaces\\FFT\\FFT\\HW-SW\\bin\\hwsw_codesign2019_aligned\\Debug"" && $(MAKE) all  "

clean:
	cmd /c "cd /D ""C:\\usr\\xtensa\\Xplorer-7.0.7-workspaces\\FFT\\FFT\\HW-SW\\bin\\hwsw_codesign2019_aligned\\Debug"" && $(MAKE) clean  "
