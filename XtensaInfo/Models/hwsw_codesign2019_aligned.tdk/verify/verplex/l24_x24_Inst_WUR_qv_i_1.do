...
//opcode WUR_qv_i_1, slot Inst, format x24, length l24:
//InstBuf : xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx1111001100101010xxxx0000
set log file l24_x24_Inst_WUR_qv_i_1.do.log -replace
...
add pin constraints 1 Instr_R[13] -Both
